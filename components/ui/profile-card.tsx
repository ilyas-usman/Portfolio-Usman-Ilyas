...
const DEFAULT_INNER_GRADIENT = "linear-gradient(145deg,#1e1b4b8c 0%,#ef444444 100%)";
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(239, 68, 68, 0.5)",
